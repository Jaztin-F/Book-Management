   ...
   private void book(){
       String databaseURL = "jdbc:derby://localhost:1527/C:/Derbydb/bmsDB";
        ...
        try {
            ...
            PreparedStatement pst = con.prepareStatement("Select BOOK_ID From BOOK");
            ResultSet rs = pst.executeQuery();
            BID.removeAllItems();
            while(rs.next()){
                BID.addItem(rs.getString(1));
                }    
        }
    ...
    private void initComponents() {
        ...
        jPanel3.add(ID, new org.netbeans.lib.awtextra.AbsoluteConstraints(146, 28, 250, 35));
        jPanel3.add(fname, new org.netbeans.lib.awtextra.AbsoluteConstraints(146, 81, 250, 35));
        jPanel3.add(lname, new org.netbeans.lib.awtextra.AbsoluteConstraints(146, 181, 250, 35));
        jPanel3.add(age, new org.netbeans.lib.awtextra.AbsoluteConstraints(146, 228, 250, 35));
        jPanel3.add(mname, new org.netbeans.lib.awtextra.AbsoluteConstraints(146, 128, 250, 35));

        BID.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
        jPanel3.add(BID, new org.netbeans.lib.awtextra.AbsoluteConstraints(146, 281, 250, 39));

        jLabel1.setFont(new java.awt.Font("Rockwell", 0, 14)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(51, 51, 51));
        jLabel1.setText("Book ID");
        jPanel3.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 300, -1, -1));
        ...
        jLabel6.setText("Age");
        jPanel3.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 246, -1, 20));
    ...
    private void showActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_showActionPerformed
        Studtbl st = new Studtbl();
        st.setVisible(true);
        dispose();
    }//GEN-LAST:event_showActionPerformed

    private void addActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addActionPerformed
         if(ID.getText().equals("")||fname.getText().equals("")||mname.getText().equals("")||lname.getText().equals("")
            ||age.getText().equals("")){
        ...
        try {
         ...
         ps.setString(6, (String) BID.getSelectedItem());
    ...
    private void updateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateActionPerformed
        ...
        try {
         ...
         String sql = "UPDATE STUDENT SET FIRST_NAME=?, MIDDLE_NAME=?, LAST_NAME=?, AGE=?, BOOK_ID=? WHERE STUDENT_ID=?";
         PreparedStatement ps = con.prepareStatement(sql);
         ...
         ps.setString(5, (String) BID.getSelectedItem());
